...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-07-2014 a las 00:18:31
...
(5, 'CAMPUS SPORT ARENA ', 'En el mítico barrio de Boedo se ubica uno de los mejores predios multideportivos para jugar al fútbol, el Campus Sport Arena. Este espacio tiene 8 canchas, seis de fútbol 5 y dos de fútbol 8. ', NULL, NULL, '13', '1', '1356', '2014-07-03 00:00:00', 0, 'H'),
(6, 'COMPLEJO VIEYTES ', 'Arrimándonos a la zona sur de la ciudad pero sin alejarnos demasiado del centro, nos encontramos con el clásico Complejo Vieytes. Ahí se desarrollan desde hace muchos años torneos de alta calidad futbolística y muy bien organizados, tanto para particulares como para empresas', NULL, NULL, '15', '1', '1510', '2014-07-03 00:00:00', 0, 'H'),
(7, 'MUNI FÚTBOL. ', 'Volviendo hacia la zona norte, detrás del club Obras Sanitarias, se destaca el predio de canchas Muni Fútbol en Núñez. Las canchas están en excelente estado y hay alternativas desde 6 hasta 8 jugadores, techadas y sin techar.', NULL, NULL, '15', '1', '1510', '2014-07-03 00:00:00', 0, 'H'),
(8, 'COMPLEJO MARANGONI ', 'En la zona norte de la ciudad y cerca del Alto Palermo, aparece un espacio en el que todo futbolista amateur alguna vez jugó un partidito: el Complejo Claudio Marangoni.', NULL, NULL, '13', '1', '1350', '2014-07-03 00:00:00', 0, 'H');
